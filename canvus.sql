...
ALTER TABLE BOOKMARK_FOLDER ADD CONSTRAINT BOOKMARK_FOLDER_PK PRIMARY KEY(USER_ID, FOLDER_NAME);
...
CREATE TABLE PAYMENT_TABLE(
    IMP_UID VARCHAR2(1000) PRIMARY KEY
    ,MERCHANT_UID VARCHAR2(200) UNIQUE
    ,PAID_AMOUNT NUMBER NOT NULL
    ,USER_ID VARCHAR2(50) NOT NULL
    ,PIXEL NUMBER NOT NULL
    ,APPLY_NUM VARCHAR2(200) NOT NULL
    ,INPUTDATE NUMBER NOT NULL
);
ALTER TABLE PAYMENT_TABLE ADD CONSTRAINT PAYMENT_TABLE_USER_ID_FK FOREIGN KEY(USER_ID) REFERENCES USERS(USER_ID);