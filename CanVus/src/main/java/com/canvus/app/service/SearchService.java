        ...
        switch (type) {
            ...
            case 1:
                ...
                if (myId != null) {
                    ...
                    Map<String, Object> followInfoPack = null;
                    List<FollowingsVO> followerList = null;

                    if (userVO != null) {
                        // TODO 팔로우 정보를 받아오는 파트
                        followInfoPack = followingsService.getFollowInfo(userVO.getUser_id());

                        // TODO 내가 팔로우한 대상인지 체크

                        if (followInfoPack != null) {
                            followerList = (List) followInfoPack.get("followerList");
