...
public class FileService {
	 ...
	 * @return 저장된 파일명
	 */
	public static String saveFile(MultipartFile mfile, String uploadPath, String user_id) {
		...
		//저장할 파일명을 오늘 날짜의 년월일로 생성 --> 목적과 달라 주석처리(유저아이디로 한다)
//		SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd");
//		String savedFilename = sdf.format(new Date());
		String savedFilename = user_id;
		...
		File serverFile = new File(uploadPath + "/" + savedFilename + ext);
		
		//같은 이름의 파일이 있는 경우의 처리 --> 주석처리 (그냥 덮어 씌울 것이다)
//		while (true) {
